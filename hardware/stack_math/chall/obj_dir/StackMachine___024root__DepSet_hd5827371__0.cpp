...
VL_INLINE_OPT void StackMachine___024root___sequent__TOP__0(StackMachine___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    StackMachine__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    StackMachine___024root___sequent__TOP__0\n"); );
    // Init
...
void StackMachine___024root___eval(StackMachine___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    StackMachine__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    StackMachine___024root___eval\n"); );
    // Body
    if (((IData)(vlSelf->clk) & (~ (IData)(vlSelf->__Vclklast__TOP__clk)))) {
        StackMachine___024root___sequent__TOP__0(vlSelf);
    }
    // Final
...
void StackMachine___024root___eval_debug_assertions(StackMachine___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    StackMachine__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    StackMachine___024root___eval_debug_assertions\n"); );
    // Body
