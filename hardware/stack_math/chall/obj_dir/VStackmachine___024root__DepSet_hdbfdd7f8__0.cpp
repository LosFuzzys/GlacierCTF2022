...
void VStackmachine___024root___eval(VStackmachine___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VStackmachine__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VStackmachine___024root___eval\n"); );
    // Body
    if (((IData)(vlSelf->clk) & (~ (IData)(vlSelf->__Vclklast__TOP__clk)))) {
        VStackmachine___024root___sequent__TOP__0(vlSelf);
    }
    // Final
...
void VStackmachine___024root___eval_debug_assertions(VStackmachine___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VStackmachine__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VStackmachine___024root___eval_debug_assertions\n"); );
    // Body
